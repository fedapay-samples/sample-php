                    ...
                    <div class="col mb-4">
                        ...
                        <div class="card  h-100">
                            <div class="text-content">
                                <p style="text-align: center; margin-left:20px;margin-right:20px; margin-top:12px;"><strong><?php echo $array[$key]["subject"] ?> 's <?php echo $array[$key]["color"] ?> Hoodie</strong></p>
                            </div>
                            <div class="card-image">
                                <a href="<?php echo $array[$key]["reference"] ?>">
                                    <img src="<?php echo $array[$key]["src"] ?>" class="rounded-25" style="max-width:100%; max-height:100%">
                                </a>
                            </div>
                            <div class="card-content mt-2 center-align">
                                <button type="button" class="btn btn-outline-primary btn-lg btn-block" data-toggle="modal" data-target="#des-<?php echo $key ?>">Détails</button>
                            </div>
                        </div>
                        <!--Description Modal-->
